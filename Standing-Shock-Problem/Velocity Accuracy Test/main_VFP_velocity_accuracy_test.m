%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% VFP Velocity Accuracy Test %%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% Tests 2nd order accuracy in velocity using IMEX222


clc; close all; clear variables;

% load reference solution 
soln = load("vdfp_refsoln_v2_Nx160_Nvperp720_Nvpara200_T1_tole-8_dt2e-1_IMEX222_QCM.mat"); % Nx=160, Nv=200, Nz=720, dt=0.2, Tf=1, tol=1e-8
...
for nvIndex = 1:numel(Nvvals)
    ...
    for t_index = 2:Nt
        ...
        parfor spatialIndex = 1:Nx
            ...
            W0_L1 = [Vz0, Dx1_Vz]*blkdiag(S0, -Dx1_S)*([Vr0, Dx1_Vr]'*(rvals .* Vr0_star));
        ...
        parfor spatialIndex = 1:Nx
            ...
            W1_L2 = W1_Vz*(W1_S')*(W1_Vr')*(rvals .* Vr1_star);
    ...
    % save('vdfp_refsoln_v2_Nx160_Nvperp200_Nvpara720_T1_tole-8_dt2e-2_IMEX222_QCM.mat','f_vals_low_rank');
    % return
...
% ------- QCM ------- %
function [n_inf, uz_inf, T_inf] = QCM(rho0, Jz0, kappa0, R, rvals, zvals)
